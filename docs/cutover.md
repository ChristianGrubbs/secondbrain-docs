...
| **Active release (R4)** | `ebf66a192ea159960500e6ea60068909ad02ffb2` (squash of [PR #13](https://github.com/ChristianGrubbs/secondbrain-docs/pull/13)), activated 2026-09-15 with the two-stage recipe below: stage 1 in the linked worktree `.claude/worktrees/dom-settle-rev3` at branch head `c142226` (content-identical to the squash; own `npm ci`; full suite 153 files / 2529 tests green after `npm run build`), stage 2 on the live checkout on `main` (`git pull --ff-only`, `rm -rf dist`, `npm ci`, `npm run build`; `dist/vault-cli.js` sha256 `461e45e5b143c31831c0d0614143b6dfc2b984115133275c71cb213b3760b9bb` on both the live checkout and the validated worktree; `doctor --json` clean). Node v22.23.2, ABI 127. Live proof: [`docs/evidence/2026-09-15-dom-settle-rev3/`](evidence/2026-09-15-dom-settle-rev3/) |
| Previous qualified SHA (R3) | `7aa85bddcd6e2b9ed41ce1e1c92408afdca12b41` (squash of [PR #11](https://github.com/ChristianGrubbs/secondbrain-docs/pull/11)), activated 2026-09-15: stage 1 on the branch head `ae623b8` (full suite 153 files / 2505 tests), stage 2 `dist/vault-cli.js` sha256 `05d310b16a14779328dc35392e3aa7e1e0e0841d057e097633e56ce95b9704d2`; `capture --no-index` parses |
...
| Older qualified SHA (R2) | `fccabebb2a833119968704db309879c3fb2562d1` (PR #10, Task 6 packet 15) — the release all live capture evidence below was produced on; R3 differs from it only by the parser fix |
