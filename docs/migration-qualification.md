...
- Tests: `src/utils/config.test.ts` (+3), `src/vault/ObsidianCli.test.ts`
  (+5), `src/vault/localAssets.test.ts` (new, 10), `src/vault/VaultPublisher.test.ts`
...
packet's PR and re-reviewed scoped (`task6-row-fixes-r2`).
